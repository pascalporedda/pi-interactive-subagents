---
name: worker-sol
description: General-purpose implementer on GPT-5.6 Sol — reads, writes, and edits code. Pick when you want the job run on Sol (thinking: medium, faster than Opus).
